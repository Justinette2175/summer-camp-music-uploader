          ...
          Body: {
            Html: {
              ...
              Data: `<h3>Bonjour ${student.firstName || student.name}!</h3>
                <p>Voici les enregistrements de la première session 2019 du cmpl! <a href=${bucketUrl}${
                student.htmlPageName
              }>Ce lien</a> ouvrira une page contenant les pièces de chorale, d'orchestre, de différents ensembles et du marathon.</p>
